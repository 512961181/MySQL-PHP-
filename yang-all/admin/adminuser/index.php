...
require "../init.php" ;
//总记录数
$sql="select count(*) total from admin_user";
$row=query($link,$sql);
$total=$row['0']['total'];
//每页显示多少条
$num=10;
...
$sql = "select * from admin_user order by id asc limit $offset,$num";
...
<body>
<div class="container index-bg2 img-rounded">
	...
	<?php foreach($user_list as $key => $val) : ?>
		<tr>
            ...
            <th><?php echo $val['tel'] ?></th>
            <th><?php echo $val['sex'] ?></th>
            <td>
