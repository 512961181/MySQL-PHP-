...
/*轮播*/
$sql = "select * from lunbo order by time desc limit 0,7;";
$lunbo = query($link,$sql);
$num=count($lunbo);//统计数组元素的个数
//echo $num;
for($i=0;$i<$num;$i++){
	$lb[$i+1]=$lunbo[$i];
	//p($lb[$i]);
...
/*企业介绍*/
//sql语句
$sql = "select * from news order by time desc limit 0,6;";
//处理结果集
$news = query($link,$sql);
$num=count($news);//统计数组元素的个数
for($i=0;$i<$num;$i++){
	$n[$i+1]=$news[$i];
	//p($n[$i+1]);
}
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">服务中心</a>
              <ul class="dropdown-menu">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="admin/login.php"><span class="glyphicon glyphicon-modal-window rmt10"></span>网站后台</a></li>
              </ul>
            </li>
          </ul>
          <?php else: ?>
